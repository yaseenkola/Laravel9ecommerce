...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-7">
                    <div class="header-content">
                        ...
                        <ul class="fa-ul">
                            <li><span class="fa-li"><i class="far fa-arrow-alt-circle-right"></i></span>Android and
                                iOS Support</li>
                            <li><span class="fa-li"><i class="far fa-arrow-alt-circle-right"></i></span>GPS & Health
                                Tracker</li>
                            <li><span class="fa-li"><i class="far fa-arrow-alt-circle-right"></i></span>Read & reply
                                to messages</li>
                            <li><span class="fa-li"><i class="far fa-arrow-alt-circle-right"></i></span>Compatible
                                with all devices</li>
                        </ul>
    ...
    <div id="products">
        <div class="container">
            ...
            <div class="mt-5 text-center"><a href="{{ route('products') }}" class="btn btn-primary">More Products</a>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <div class="contact-info">
                        ...
                        <h3><i class="fa fa-map-marker"></i>KAR, KAWR, IN</h3>
                        <h3><i class="fa fa-envelope"></i>yaseenkola@gmail.com</h3>
                        <h3><i class="fa fa-phone"></i>+91-702-644-2627</h3>
